...
{
    public class NarudzbeService : BaseCRUDService<Model.Narudzbe, Database.Narudzbe, BaseSearchObject, NarudzbeInsertRequest, NarudzbeUpdateRequest>, INarudzbeService
    {
        public NarudzbeService(eProdajaContext context, IMapper mapper) : base(context, mapper)
        {
        }

        public override void BeforeInsert(NarudzbeInsertRequest insert, Narudzbe entity)
        {
        ...
        public override Model.Narudzbe Insert(NarudzbeInsertRequest insert)
        {
